---
name: node-dispatch
description: "Selects the next pending architecture node relevant to the current milestone and dispatches to node-decompose. Use when working through MILESTONES.md with pending architecture nodes."
